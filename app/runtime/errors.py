...
_KNOWN_TOOL_ERRORS: dict[str, tuple[ErrorType, bool]] = {
    ...
    "skill_reference_manifest_not_found": (ErrorType.NOT_FOUND, False),
    "skill_reference_not_found": (ErrorType.NOT_FOUND, False),
    "skill_reference_manifest_invalid": (ErrorType.INVALID_ARGUMENTS, False),
    "skill_reference_forbidden": (ErrorType.PERMISSION_DENIED, False),
    "skill_reference_too_large": (ErrorType.INVALID_ARGUMENTS, False),
    "skill_source_manifest_not_found": (ErrorType.NOT_FOUND, False),
    "skill_source_not_found": (ErrorType.NOT_FOUND, False),
    "skill_source_manifest_invalid": (ErrorType.INVALID_ARGUMENTS, False),
    "skill_source_forbidden": (ErrorType.PERMISSION_DENIED, False),
    "source_http_error": (ErrorType.TRANSIENT_ERROR, True),
    "source_fetch_failed": (ErrorType.TRANSIENT_ERROR, True),
    "skill_helper_manifest_not_found": (ErrorType.NOT_FOUND, False),
    "skill_helper_not_found": (ErrorType.NOT_FOUND, False),
    "skill_helper_manifest_invalid": (ErrorType.INVALID_ARGUMENTS, False),
    "skill_helper_forbidden": (ErrorType.PERMISSION_DENIED, False),
    "skill_helper_timeout": (ErrorType.TIMEOUT, True),
    "skill_helper_failed": (ErrorType.INTERNAL_ERROR, False),
